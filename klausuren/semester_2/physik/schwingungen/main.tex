...
\begin{wrapfigure}{l}{4cm}
 \begin{tikzpicture}
  \draw (0, 0) -- (4, 0);
  \draw (0, 0) -- ({4*cos(30)}, {4*sin(30)}) node [midway, above left] {$r$};
  \draw (1, 0) arc[start angle=0,end angle=30,radius=1] node[midway, left, yshift=-0.5ex] {$\varphi$};  
  \draw (4, 0) arc[start angle=0,end angle=30,radius=4] node[midway, right] {$b$}; 
 \end{tikzpicture}
\end{wrapfigure}  

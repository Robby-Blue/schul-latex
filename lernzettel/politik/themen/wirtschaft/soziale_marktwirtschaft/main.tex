...
\end{multicols}
\noindent Der Staat hat hier die Rolle die oben genannten Prinzipien zu gewährleisten, aber nicht viel mehr zu tun. Dies passiert durch das Setzen der Ordnungspolitik, Institutionen, VerbraucherInnenschutzgesetze, \emph{öffentliche} (kostenlose, wettbewerbslose) und \emph{meritorische} (staatlich subventionierte) Güter, soziale Sicherung, Steuern, usw.
 
\emph{Wie viel genau} der Staat handeln soll ist eine Wertefrage und stellt den Konflikt zwischen der \emph{Effizienz} und der \emph{Gerechtigkeit} dar. 

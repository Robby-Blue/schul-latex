...
\begin{description}
 ...
 \item[Gerechte Einkommens- und Vermögensverteilung] Hier ist aber nicht definiert, was genau \textquote{gerecht} bedeutet. Das soll eine individuelle politische Wertentscheidung sein
...
\begin{multicols}{1} 
\noindent Das magische Sechseck wird \textquote{magisch} genannt, weil es nie möglich ist, alle Ziele komplett zu erreichen; stattdessen stehen viele in Konflikt zueinander.
\begin{description*}

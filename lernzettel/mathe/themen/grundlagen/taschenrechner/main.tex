...
\begin{description}
 ...
 \item[Normalfunktionen] Eine \hyperref[Normalfunktion]{Normalfunktion} ist im \texttt{menu}, \calckey{5}, \calckey{5}, \calckey{1} aufzufinden. Deren Cdf ist bei unter \texttt{menu}, \calckey{5}, \calckey{5}, \calckey{2} aufzufinden.
 \item[Inverse Normalfunktion] Eine \hyperref[Inverse Normalfunktion]{Inverse Normalfunktion} \texttt{invNorm(A, $\mu$, $\sigma$)} ist im \texttt{menu}, \calckey{5}, \calckey{5}, \calckey{3} aufzufinden.
\end{description} 

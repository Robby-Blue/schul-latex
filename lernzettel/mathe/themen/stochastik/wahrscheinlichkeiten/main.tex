...
Die Wahrscheinlichkeit, dass \textquote{entweder $E_1$ oder $E_2$} passiert ist die Wahrscheinlichkeit, dass $E_1$ oder $E_2$ aber nicht $E_1$ und $E_2$ gleichzeitig passieren. Das ist $P(E_1) + P(E_2) - 2 \cdot P(E_1 \cap E_2)$.

...
Wird ein Experiment durchgeführt, bei welchem gezählt wird, wie Häufig bestimmte Trefferzahlen bei einer Bernoulli-Kette vorkommen, so ist dies eine \emph{Häufigkeitsverteilung}. Diese kann durch eine Binomialverteilung beschrieben werden.

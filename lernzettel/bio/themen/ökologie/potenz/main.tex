...
\subsection{Die ökologische Nische}
Die ökologische \emph{Nische} beschreibt die Gesamtheit der Ansprüche einer Art auf ihre Umwelt. Sie kann darin unterschieden werden, ob sie sich auf die physiologische oder die ökologische Potenz bezieht, in jeweils die \emph{Fundamental}nische und die \emph{Real}nische.
...
Anhand einer Toleranzkurve beziehungsweise eines Ökogramms kann die \hyperref[Konkurrenz]{interspezifische Konkurrenz} zwischen zwei Tierarten analysiert werden. Zu dieser kommt es, wenn beide Tierarten eine überlappende ökologische Nische haben. Es können die Toleranzkurven oder die Ökogramme beider betrachtet werden und untersucht werden ob es bestimmte Lebensbedingungen gibt, unter welchen beide Tierarten gut leben könnten und um welche sie kämpfen könnten.
\end{document}
...
Weil die Nachkommen mit einem Y-Chromosom immer das Y-Chromosom des Vaters und kein anderes Chromosom haben werden, werden sie immer die gleiche Ausprägung haben wie der Vater. Somit ist eine gonosomale Vererbung über das Y-Chromosom trivial zu erkennen.
...
Haben zwei Elternteile mit einer Ausprägung einen Sohn ohne dieser, so kann die Vererbung werder gonosomal-rezessiv noch gonosomal-dominant stattgefunden haben, sie muss autosomal gewesen sein.
...
Dass ein Vater mit Ausprägung, eine Mutter ohne Ausprägung und ein Kind mit Ausprägung ist rezessiv.
 
Weitere fälle können selbst überprüft werden. 

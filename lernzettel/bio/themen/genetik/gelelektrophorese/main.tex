...
\subsection{Ablauf}
Hier werden die DNA-Abschnitte, welche mit der PCR vervielfältigt wurden, in Taschen im Gel gefüllt, an welches Gleichstrom angeschlossen wird. Die DNA ist negativ, bewegt sicht also zur Anode. Hier bewegen sich kleinere DNA-Abschnitte schneller, kommen weiter.
...
\begin{description} 
 ...
 \item[Polymerisation] Bei ungefähr $70\,^\circ C$ setzt die Taq-Polymerase, eine Polymerase welche an hohe Temperaturen angepasst ist, am Primer an und binder die komplementären Nukleotide.
\end{description} 

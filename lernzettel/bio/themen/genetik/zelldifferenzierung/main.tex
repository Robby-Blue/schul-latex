...
\emph{Transkriptionsfaktoren} sind Proteine, welche als ein Faktor der \emph{Transkriptionsgeschwindigkeit} arbeiten; \emph{ob} und \emph{wie häufig} es zur Transkription kommt. Es wird weiter zwischen \emph{allgemeinen} und \emph{spezifischen} Transkriptionsfaktoren unterschieden.
\begin{description}
...
\end{description}
Nun können Stoffe an Rezeptorproteinen binden (wie z.\,B. Östrogen zu einem Östrogen-Rezeptor-Komplex), um zusammen als spezifische Transkriptionsfaktoren zu agieren. 

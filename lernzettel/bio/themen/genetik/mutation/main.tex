...
\begin{description}
 \item[Substitution] Ein Nukleotid der Sequenz wird substituiert, heißt ausgetauscht. Wie groß dessen folgen sind, kommt darauf an, welche Sequenz wie ausgetauscht ist.
  \begin{description}
   ...
   \item[Nonsense] Das Codon wird zu einem Stopp-Codon, die Aminosäurensequenz endet frühzeitig. 
  ...
  \end{description} 
 \item[Frameshift] Die Nukleotide werden, im vergleich zum Leserahmen des Ribosoms, verschoben (geshifted), weil eines hinzugekommen oder verschwunden ist. Alle darauffolgenden Codons beziehungsweise Aminosäuren verändern sich.
\end{description} 
\end{document}
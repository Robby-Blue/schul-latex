...
\begin{description}
 \item[Substitution] Ein Nukleotid der Sequenz wird substituiert, heißt ausgetauscht. Wie groß dessen folgen sind, kommt darauf an, welche Sequenz wie ausgetauscht ist.
  ...
  \end{description} 
 \item[Frameshift] Die Nukleotide werden verschoben (geshifted), weil eines hinzugekommen oder verschwunden ist. Alle darauffolgenden Codons beziehungsweise Aminosäuren verändern sich.
\end{description} 
\end{document}
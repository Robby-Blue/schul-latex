...
Die natürliche Selektion ist ein wichtiger Evolutionsfaktor. Durch diese nimmt die Allelenfrequenz der Allelen, die letztendlich für einen angepassteren Phänotypen codieren, zu. 
 
\subsection{Funktionsweise} 
Diese besagt dass Lebewesen eine \emph{reproduktive Fitness} haben, die angibt, wie gut ein Lebewesen, basierend auf dessen Phänotypen (letztendlich auf dem Genotypen basierend), sich fortpflanzen kann. Ist ein Lebewesen besser an die eigene Umwelt angepasst, so hat es eine höhere reproduktive Fitness.
...
\end{description}
Die relevantesten Fälle handeln von \emph{gerichteter} Selektion.
\end{document}
...
\begin{description} 
 ...
 \item[Allelfrequenz] Die Häufigkeit von verschiedenen Genvarianten.
 \item[Evolutionsfaktoren] Faktoren, welche die Allelenfrequenz verändern.
 \item[Rekombination] Neukombination der Gene der Eltern bei der Bildung von Kindern.
 \item[Mutation] Der einzige Weg, neue Allele in Populationen einzubringen. Siehe das Kapitel \hyperref[Mutationen]{Mutationen}. 
\end{description} 
\end{document}
...
Erreicht das Aktionspotential die Synapse, so öffnen sich die \ce{Ca2+}-Ionenkanäle und \ce{Ca2+}-Ionen gelangen in das präsynaptische Knöpfchen. Diese binden sich an die Vesikel, welche sich daraufhin zur Membran bewegen.
 
Der Vesikel \textquote{verschmelzen} mit der Membran, deren Inhalt, ein spezifischer Neurotransmitter, wird in den synaptischen Spalt freigelassen. Diese binden an Rezeptoren der postsynaptischen Membran, so dass die postsynaptischen Ionenkanäle geöffnet werden.
...
Ein Enzym, z.\,B. Cholinesterase spaltet das den Neurotransmitter, z.\,B. ACh zu A und Ch, welche einzeln wieder in das präsynaptische Knöpfchen gelangen, dort den gleichen Neurotransmitter wieder bilden und die Vesikel erneut bilden. 

\subsection{Motorische Endplatte}
Eine \emph{motorische Endplatte} ist eine Art Synapse, welche als postsynaptise eine Muskelfaser und als Neurotransmitter Acetylcholin nutzt. Diese wird genutzt um Erregungen vom Motoneuron an Muskeln zu übertragen.
\end{document}
...
Aufgrund des Konzentrationsgradienten diffundiert \ce{H+}-Ion durch die ATP-Synthase, dabei wird genug Energie geliefert, so dass \ce{ADP + P -> ATP} reagieren kann; so kann die chemiosmotische Energie die des bestehenden \ce{H+}-Konzentrationsgradienten kann genutzt werden um ATP zu synthetisieren.
\end{document}
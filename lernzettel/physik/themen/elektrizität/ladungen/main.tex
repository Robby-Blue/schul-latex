...
\begin{multicols}{2}
 ...
 \begin{center}
  ...
   
   ...
   \draw (0.7, 0) node[blue] {$-$} node[red, right] {$+$};  
   \draw (0.9, 0.3) node[blue] {$-$} node[red, right] {$+$};   
   \draw (0.85, -0.4) node[blue] {$-$} node[red, right] {$+$};  
   \draw (1, 0.7) node[blue] {$-$} node[red, right] {$+$};  

...
\begin{description}
 \item[$\alpha$-Strahlung] Bei der $\alpha$-Strahlung werden zwei Protonen und zwei Neutronen emittiert, genau der Aufbau eines Heliumkerns. Somit kann die $\alpha$-Strahlung als $\ksymb{4}{2}{He}$ oder als $\ksymb{4}{2}{\alpha}$ aufgeschrieben werden. Dies ist zweifach positiv und sehr einfach Abschirmbar. 
...
Hier wird im Kern ein Proton in ein Positron, ein Neutron und ein Elektronenneutrino geteilt.
\[
...
\end{description}
$\alpha$- und $\beta$ Strahlung geht immer auf eine Kernumwandlungen zurück. Der Kern wandelt sich nur um, weil der Folgekern stabiler ist. 

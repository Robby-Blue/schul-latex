...
\subsection{Aufbau}
Die Teilchen liegen im Kern als de-Broglie-Wellen in einem Potentialtopf, analog zum Potentialtopf der Farbstoffmoleküle vor. Deshalb sind auch ihre Energie quantisiert, heißt, nur diskret.
   
\subsection{Größenordnung der Energie}
Es wird sich die \hyperref[Der Potentialtopf]{hier hergeleitete}, oder in der Formelsammlung auffindbare, Formel für die Energien in Atomen, welche auch für Nukleonen im Kern funktioniert, angeguckt 
\[
 E = \frac{h^2}{8mL^2} \cdot n^2
\]  
$m$ ist die Masse des Teilchens, $L$ der Kerndurchmesser ($\approx 10^{-14}\,\text{m}$), $n$ der Zustand (im Grundzustand $n=1$)
 
So hat Beispielsweise ein Proton im Grundzustand eine Energie von $\approx 2,048\,\text{MeV}$.

...
\[ 
 \Delta m = m_{\text{atom}} - n_e \cdot m_e - n_p \cdot m_p - n_n \cdot m_n
\]
Hier sind $n_e$, $n_p$ und $n_n$ jeweils die Anzahlen der Elektronen, Protonen und Neutronen und $m_e$, $m_p$ und $m_n$ sind die Massen der drei Teilchenarten. Diese sind auch im Taschenrechner als \texttt{\_Me}, \texttt{\_Mp} und \texttt{\_Mn} vorgespeichert. 

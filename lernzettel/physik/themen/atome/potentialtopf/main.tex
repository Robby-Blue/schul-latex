...
Der Potentialtopf macht keine genaue Aussage darüber, wo sich die Elektronen oder andere Teilchen aufhalten, nur wo welche Aufenthaltswahrscheinlichkeiten aufzufinden sind. Dies kann natürlich als Grenze angesehen werden, ist aber zugleich eine Stärke darin, dass es, wird es als Atommodell angesehen, im Vergleich zum \hyperref[Das Bohrsche Atommodell]{Bohrschen Atommodell} kein Widerspruch mit der \hyperref[Heisenbergsche Unschärferelation]{Heisenbergsche Unschärferelation} darstellt.
\end{document}
...
Die bevorzugten Aufenthaltsbereiche der Elektronen in diesem Topf können visualisiert werden. Die Dichte der Wolke stellt dar, wie groß an demjenigen Punkt die Nachweiswahrscheinlichkeit des Elektrons ist.
...
Werden alle Permutationen bis $n_{\{x,y,z\}}=2$ gezählt, so gibt es 8 mögliche Zustände. Mit je zwei Elektronen, kann ein dreidimensionaler Potentialtopf bis $n=2$ maximal 16 Elektronen enthalten. 
 
Der dreidimensionale Potentialtopf ist bereits dem Potentialtopf des Wasserstoffatoms sehr ähnlich, in der Bedeutung, der Dimensionenzahl usw. Lediglich die genaue Form des Potentials und der Wolken ist anders.

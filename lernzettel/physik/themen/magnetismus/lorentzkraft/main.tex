...
Die Richtung der Auswirkung eines Magnetfeldes kann mithilfe \emph{UVW}-Regel bestimmt werden. Dabei wird der Daumen, der Zeige- und Mittelfinger der linken Hand in jeweils $90^\circ$ Winkeln ausgestreckt. Dabei stellt jeder Finger immer die Richtung einer Kraft dar.
\begin{center}
\begin{tabular}{ lcc }
\toprule
 Bedeutung & Richtung & Finger \\
\midrule  
 \colorbox{red!30}{U}rsache & Richtung der Elektronenbewegung & Daumen \\
 \colorbox{red!30}{V}ermittlung & Richtung der Magnetfeldlinien & Zeigefinger \\
 \colorbox{red!30}{W}irkung & Richtung der Kraft & Mittelfinger \\
\bottomrule 
\end{tabular}
\end{center}
Sind zwei Richtungen bekannt, kann diese Regele angewand werden, um die dritte zu finden.
 
Hier ist es wichtig sich daran zu Erinnern, dass die technische Stromrichtung und die Richtung der Elektronenbewegung entgegengesetzt sind. 

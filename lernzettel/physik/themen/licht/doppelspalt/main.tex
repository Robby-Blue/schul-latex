...
Ein Dreifachspalt, ein Vierfachspalt, usw. geben ein sehr ähnliches Interferenzmuster, nur mit Zwischenmaxima zwischen den eigentlichen Maxima. Die eigentlichen Maximas sind trotzdem an der gleichen Position.
 
Die Nebenminima und Nebenmaxima entstehen nun gleichermaßen, durch die destruktive beziehungsweise konstruktive Interferenz, nur in Bezug auf mehr Spalte. Sollen diese analysiert werden, so kann der Gangunterschied zwischen zwei benachbarten Spalten berechnet werden und überlegt werden, was daraus folgt (z.\,B. \textquote{alle $k$ Spalte löschen sich gegenseitig aus und es gibt $n$ Spalte}).
